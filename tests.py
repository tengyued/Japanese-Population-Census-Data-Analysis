...
# election.py into the current environment. The reload function will make 
# sure that you are using the most up-to-date version of election.py.
#import election
#reload(election)
#rom election import *
...
def test_row_to_edge():
    row1 = { "State": "AR", "Dem": "5", "Rep": "90" }
    assert eq(row_to_edge(row1), -85)

    row2 = { "State": "NC", "Dem": "57.5", "Rep": "77.5" }
    assert eq(row_to_edge(row2), -20)

    row3 = { "State": "NJ", "Dem": "52", "Rep": "49", "Lib": "1" }
